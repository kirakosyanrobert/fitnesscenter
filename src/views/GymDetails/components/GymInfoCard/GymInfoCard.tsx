...
export const GymInfoCard = ({gym}: {gym: Gym}) => {
  const { name, bio, description, instagramNick, imageUrl } = gym;
  return (
    <Card variant="outlined">
      ...
      <CardContent>
        ...
        <Typography gutterBottom variant="h6" component="h6" textAlign="center">
          {bio}
        </Typography>
